...
def render() -> None:
    ...
    with st.expander("Clinical Effects of Acidemia", expanded=False):
        st.markdown(
            "Acidemia (arterial pH < 7.35) has widespread pathophysiologic consequences "
            "that worsen with severity. Many effects become clinically significant below pH ~7.20 "
            "and life-threatening below ~7.10.\n\n"
            "### Cardiovascular\n\n"
            "| Effect | Mechanism |\n"
            "| --- | --- |\n"
            "| **Decreased myocardial contractility** | H⁺ impairs Ca²⁺ binding to troponin and reduces sarcoplasmic reticulum Ca²⁺ release |\n"
            "| **Reduced responsiveness to catecholamines** | H⁺ decreases β-adrenergic receptor affinity; vasopressors become less effective |\n"
            "| **Vasodilation (systemic)** | Direct arteriolar smooth muscle relaxation; contributes to refractory hypotension |\n"
            "| **Pulmonary vasoconstriction** | Opposite of systemic effect — worsens RV afterload |\n"
            "| **Arrhythmias** | Altered ion channel kinetics; hyperkalemia (see below) lowers the threshold for ventricular arrhythmias |\n"
            "| **Decreased cardiac output** | Combined effect of reduced contractility, preload changes, and arrhythmias |\n\n"
            "### Metabolic & Electrolyte\n\n"
            "| Effect | Mechanism |\n"
            "| --- | --- |\n"
            "| **Hyperkalemia** | H⁺ enters cells in exchange for K⁺ (transcellular shift); ~0.6 mEq/L rise in K⁺ per 0.1 drop in pH (variable, more prominent in mineral acidoses) |\n"
            "| **Ionized hypercalcemia** | H⁺ displaces Ca²⁺ from albumin binding sites, increasing ionized fraction |\n"
            "| **Insulin resistance** | Impaired peripheral glucose uptake; worsens hyperglycemia |\n"
            "| **Increased protein catabolism** | Stimulates ubiquitin-proteasome pathway; contributes to muscle wasting in chronic acidosis |\n"
            "| **Impaired cellular energy production** | Inhibits phosphofructokinase and other glycolytic enzymes at very low pH |\n\n"
            "### Respiratory\n\n"
            "| Effect | Mechanism |\n"
            "| --- | --- |\n"
            "| **Compensatory hyperventilation** | Peripheral chemoreceptors (carotid bodies) and central medullary sensing drive increased minute ventilation (Kussmaul breathing in metabolic acidosis) |\n"
            "| **Respiratory muscle fatigue** | Sustained hyperventilation increases work of breathing; diaphragmatic fatigue may precipitate respiratory failure |\n"
            "| **Right-shifted oxyhemoglobin dissociation curve (Bohr effect)** | H⁺ decreases Hb-O₂ affinity → facilitates O₂ unloading at tissues but may impair loading at the lungs in severe cases |\n\n"
            "### Neurologic\n\n"
            "| Effect | Mechanism |\n"
            "| --- | --- |\n"
            "| **Altered mental status** | Direct neuronal depression; ranges from confusion to obtundation to coma |\n"
            "| **Cerebral vasodilation** | CO₂/H⁺ mediated; may raise ICP |\n\n"
            "### Hematologic\n\n"
            "| Effect | Mechanism |\n"
            "| --- | --- |\n"
            "| **Impaired coagulation** | Acidemia reduces activity of coagulation factors (enzymatic function is pH-dependent); contributes to the \"lethal triad\" (acidosis, hypothermia, coagulopathy) in trauma |\n"
            "| **DIC and fibrinolysis** | Severe acidosis can promote disseminated intravascular coagulation |\n\n"
            "### Clinical Pearls\n\n"
            "- **pH < 7.20** is the general threshold where cardiovascular compromise accelerates — "
            "catecholamine responsiveness drops significantly\n"
            "- **Correcting the underlying cause** is always the priority — bicarbonate infusion "
            "is controversial and may worsen intracellular acidosis (CO₂ diffuses into cells faster than HCO₃⁻)\n"
            "- In **DKA**, the acidosis itself is rarely the indication for bicarbonate; "
            "guidelines generally reserve it for pH < 6.9–7.0\n"
            "- **Permissive hypercapnia** in ARDS accepts mild respiratory acidosis (pH ~7.25–7.35) "
            "to avoid ventilator-induced lung injury — the tradeoff is generally favorable\n"
            "- The **hyperkalemia of acidosis** reverses with pH correction — anticipate hypokalemia "
            "as acidosis resolves and replace proactively"
        )
